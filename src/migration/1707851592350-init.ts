...
export class Init1707851592350 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "attachments" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "deleted_at" TIMESTAMP, "created_at" TIMESTAMP NOT NULL DEFAULT now(), "updated_at" TIMESTAMP NOT NULL DEFAULT now(), "title" character varying, "name" character varying, "original_name" character varying, "visibility" "public"."attachments_visibility_enum" NOT NULL, "mime_type" jsonb, "size" integer NOT NULL, "uploader_id" character varying NOT NULL, CONSTRAINT "PK_ATTACHMENTS_ID" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE INDEX "IDX_ATTACHMENTS_UPLOADER_ID" ON "attachments" ("uploader_id") `);
        await queryRunner.query(`CREATE TABLE "attachment_users" ("attachment_id" character varying NOT NULL, "user_id" character varying NOT NULL, CONSTRAINT "PK_ATTACHMENT_USERS_ID" PRIMARY KEY ("attachment_id", "user_id"))`);
