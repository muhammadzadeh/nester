...
import { TypeormRoleEntity } from './infrastructure/database/entities/typeorm-role.entity';
import { TypeormRolesRepository } from './infrastructure/database/repositories/typeorm-roles.repository';
import { RoleController } from './presenter/http/role.controller';
